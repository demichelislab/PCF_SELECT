...
#sif <- fread("/SPICE/downloads/PCF_SELECT/analyses/BetaComputation/UCL/sif.tsv")
sif <- fread("/SPICE/downloads/PCF_SELECT/analyses/BetaComputation/Cornell/SIF.tsv")
...
write.table(peaks_shifts, file = "/SPICE/downloads/PCF_SELECT/analyses/peak_correction/peaks_shifts_Cornell.tsv", sep = "\t", quote = F, col.names = T,
            row.names = F)
shift <- fread("/SPICE/downloads/PCF_SELECT/analyses/peak_correction/peaks_shifts_Cornell.tsv")
...
save(germ.distr, file = "/SPICE/downloads/PCF_SELECT/analyses/peak_correction/Germ_Distr_Cornell_shifted.RData")
